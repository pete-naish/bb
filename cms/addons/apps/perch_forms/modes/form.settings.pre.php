<?php
    ...
    if ($Form->submitted()) {
    	...
    	$settingvars = array('store','fileLocation', 'email', 'emailAddress', 'adminEmailMessage', 'adminEmailSubject', 'adminEmailFromName', 'adminEmailFromAddress', 'akismet', 'akismetAPIKey');
